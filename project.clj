(defproject dualactivityapp/dualactivityapp "0.1.0-SNAPSHOT"
             ...
             [:android-common :android-user
              {:dependencies [[org.clojure/tools.nrepl "0.2.10"]]
               ...
               :android {:aot :all-with-unused
                         :manifest-options {:app-name "DualActivityApp (debug)"}
                         ;; Uncomment to be able install debug and release side-by-side.
                         ;; :rename-manifest-package "se.nyrell.dualactivity.debug"
                         }}]
             :release
             [:android-common
